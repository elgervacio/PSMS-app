                    ...
                    <div className="p-4 space-y-3 md:space-y-6 sm:p-8">
                        <div className='flex justify-center border-b-[1px] border-gray-300 pb-[20px]'>
                            <a href="#" className="flex items-center text-2xl font-semibold text-gray-900 dark:text-white">
                                <img className="w-[115px] h-[115px] mr-2" src={Image} alt="logo" />
                            </a>
                        </div>
                        <form className="space-y-3 md:space-y-2" action="">
                            <div className='mb-3'>
                                <label htmlFor="email" className="label">Database</label>
                                <div className=' input-group'>

                                    <input type="text" name="db" id="database" className="form-control" placeholder="Database name" required="" readOnly="readonly" autoFocus />
